"""
The following code has been adapted from https://github.com/BenjaminDoran/unidip/tree/master. Modifications were made to
allow its use in conjunction with later versions of numpy.

Original Author: Benjamin Doran
Date: Mar 2018
Algorithm:
